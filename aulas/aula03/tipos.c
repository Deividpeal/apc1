...
int main() {  
  ...
  printf("o tamanho do char na memoria eh %lu bute(s)\n", sizeof(char));
  printf("o tamanho do int na memoria eh %lu bute(s)\n", sizeof(int));  
  printf("o tamanho do int na memoria eh %lu bute(s)\n", sizeof(float));
  printf("o tamanho do int na memoria eh %lu bute(s)\n", sizeof(double));
  ...
  printf("\n");
  printf("a faixa de valores do unsingned char vai de %i ate %i\n", 0, UCHAR_MAX);
  printf("a faixa de valores do unsingned short int vai de %i ate %i\n", 0, USHRT_MAX);
  printf("a faixa de valores do unsingned int vai de %i ate %lu\n", 0, UINT_MAX);
  printf("a faixa de valores do unsingned long int vai de %i ate %lu\n", 0, ULONG_MAX);
